<nav class="navbar navbar-expand-sm bg-body-tertiary" style="background-color: black !important;">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="img/google-st-i5q.png" width="50"></a>
...
<div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" sp="linknav" aria-current="page" href="index.php">Stadia</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" sp="linknav" href="juegos.php">Juegos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" sp="linknav" href="contactanos.php">Contáctanos</a>
        </li>
      </ul>
    </div>
